# Patched starting stub of `ptucc`
...
have to read the `ptuc` language definition. Alternatively, if you want to just execute the test or the example
files you have two options, which are:
